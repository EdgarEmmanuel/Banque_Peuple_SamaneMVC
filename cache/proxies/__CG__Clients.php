...
class Clients extends \Clients implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Clients' . "\0" . 'id', '' . "\0" . 'Clients' . "\0" . 'telephone', '' . "\0" . 'Clients' . "\0" . 'email', '' . "\0" . 'Clients' . "\0" . 'matricule'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTelephone(?string $telephone): \Clients
    {
     ...
     * {@inheritDoc}
     */
    public function setMatricule(string $matricule): \Clients
    {
